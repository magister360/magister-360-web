  ...
  return (
    ...
    >
      ...
      <div className=" flex  ">
        ...
        >
          <label
            className="block text-gray-700 dark:text-gray-200 font-bold text-xl mb-2"
        ...
        <div
          className="flex flex-col  flex-1 mt-14 ml-2  rounded-lg shadow  
                    sm:max-w-md  dark:bg-[#18181B] bg-[#ffffff]  p-5"
        >
          <label
          ...
          <p>Educación prescolar, primaria y secundaria</p>
