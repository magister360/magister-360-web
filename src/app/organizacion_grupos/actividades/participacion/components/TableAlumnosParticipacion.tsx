"use cliente";
import { ItemStudentParticipacion, StudentParticipacion } from "@/app/types/types";

type Props = {
  alumnos: ItemStudentParticipacion[];
          ...
          >
            ...
            <tbody>
              {alumnos.map((alumno, index) =>
                ...
                ) : <div className=" items-center text-justify justify-center">No existen datos</div>
              )}
