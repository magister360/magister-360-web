...
type Props = {
  readonly alumnos: StudentTarea[];
  readonly setSelectAlumno: (alumno: StudentTarea | undefined) => void;
  readonly setFechasTareas: React.Dispatch<
...
export default function TableTareaSeguimiento({
  alumnos,
  setSelectAlumno,
  setFechasTareas,
  setSelectPeriodo
}: Props) {
  const handleSelectAlumno = (alumno: StudentTarea) => {
    setSelectAlumno(alumno);
    setFechasTareas(null);
