...
type Props = {
  readonly alumnos: StudentExamen[];
  readonly setSelectAlumno: (alumno: StudentExamen | undefined) => void;
 // readonly setFechasExamenes: React.Dispatch<
...
export default function TableParticipacionSeguimiento({
  ...
  const handleSelectAlumno = (alumno: StudentExamen) => {
    setSelectAlumno(alumno);
    //setFechasExamenes(null);
