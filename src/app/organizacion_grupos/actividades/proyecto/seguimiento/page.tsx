...
import { StudentProyecto, TypeProyectoFecha } from "@/app/types/proyecto/TypeProyecto";
import { getAlumnosProyecto, getFechasProyecto, getFechasProyectoAlumno } from "./controller/SegProyectoController";
...
export default function Seguimiento() {
  ...
  const [fechasProyectos, setFechasProyectos] = useState<
    string[] | null
  >([]);
